...
var eyeData = ExpressorData{
  Ranges: []ExpressorRange{
    ...
    bit12Expr.Expression("eyes>small_eyes", 0.89, 0.96, false),
...
var hairData = ExpressorData{
  Ranges: []ExpressorRange{
    bit12Expr.Expression("none", 0, 0.15, true),
...
var mouthData = ExpressorData{
  Ranges: []ExpressorRange{
    ...
    bit12Expr.Expression("mouth>mad_lips_2", 0.71, 0.73, false),
    bit12Expr.Expression("mouth>mad_mouth", 0.73, 0.76, false),
...
var shirtData = ExpressorData{
  Ranges: []ExpressorRange{
    ...
    bit8Expr.Expression("shirt>basic_shirt", 0.58, 0.75, false),
...
var glassesData = ExpressorData{
  Ranges: []ExpressorRange{
    ...
    bit8Expr.Expression("glasses>vr_set", 0.5, 0.55, false),
    bit8Expr.Expression("glasses>explosion_goggles", 0.55, 0.58, false),
    bit8Expr.Expression("glasses>pirate_hat", 0.58, 0.6, false),
    bit8Expr.Expression("glasses>smart glasses", 0.6, 0.78, false),
